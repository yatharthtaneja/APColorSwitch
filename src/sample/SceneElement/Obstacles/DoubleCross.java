...
public class DoubleCross extends sample.SceneElement.Obstacles.Obstacle {
    ...
    public DoubleCross(double x,double y){
        ...
        Shape shape1= new Pentagon((x-100)+32.5,y-162,0, Color.web("#35e2f2"));
        Shape shape2= new Pentagon((x-100)+32.5,y-77.5,90,Color.web("#f6df0e"));
        Shape shape3= new Pentagon((x-100)-52.5,y-77.5,180,Color.web("#8c13fb"));
        Shape shape4= new Pentagon((x-100)-52.5,y-162,270,Color.web("#ff0080"));
        ...
        Shape shape5= new Pentagon((x+100)+32.5,y-162,0, Color.web("#8c13fb"));
        Shape shape6= new Pentagon((x+100)+32.5,y-77.5,90,Color.web("#ff0080"));
        Shape shape7= new Pentagon((x+100)-52.5,y-77.5,180,Color.web("#35e2f2"));
        Shape shape8= new Pentagon((x+100)-52.5,y-162,270,Color.web("#f6df0e"));
